...
subroutine flux_cell_faces(flux_dim, u, flux, max_wavespeed, u_LR, flux_LR)
  ...
  call flux_hll_one_side(flux_dim, 0, u, flux(:, 1), max_wavespeed, u_LR, flux_LR)
  call flux_hll_one_side(flux_dim, 1, u, flux(:, 2), c_tmp, u_LR, flux_LR)
  max_wavespeed = max(max_wavespeed, c_tmp)
end subroutine flux_cell_faces

subroutine flux_hll_one_side(flux_dim, i0, u, flux, max_wavespeed, u_LR, flux_LR)
  ${ROUTINE_SEQ()}$
  integer, intent(in)     :: flux_dim
